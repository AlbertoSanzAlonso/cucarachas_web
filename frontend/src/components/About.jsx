      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
         ...
         >
           ...
           <h2 className="text-3xl md:text-5xl font-black text-secondary-gray mb-8 leading-[1.15] tracking-tight">
             {t('about.title_part1')}
            ...
            <div className="space-y-6 mb-10 text-left">
              ...
              <div className="bg-white p-8 rounded-[2rem] border-l-4 border-primary-blue shadow-sm italic text-secondary-gray font-serif text-lg leading-relaxed">
                "{t('about.quote')}"
              </div>
            </div>
              ...
              {values.map((v, i) => (
                <div key={i} className="flex gap-4 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-muted font-bold leading-snug opacity-80">{v.desc}</p>
                  </div>
                </div>
              ))}
            </div>
