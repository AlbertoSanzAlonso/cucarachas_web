...
const Footer = ({ className = "" }) => {
  ...
  return (
    <footer className={`relative mt-32 text-white ${className}`}>
      {/* Skewed Top Transition with INTENSE Shadow */}
      <div 
        className="absolute inset-x-0 top-0 h-48 -skew-y-3 origin-top-right transform -translate-y-24 z-0 shadow-[0_-40px_80px_rgba(0,0,0,0.4)]"
        style={{ background: '#0a1a2f' }}
      ></div>

      <div className="relative pt-48 pb-12 overflow-hidden z-10" style={{ background: '#0a1a2f' }}>
