    ...
    <section className="pt-40 pb-24 bg-white relative z-30" id="process">
      ...
      {createPortal(
        <AnimatePresence mode="wait">
          {selectedStep && (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-6 overflow-hidden [@media(max-height:600px)_and_(orientation:landscape)]:p-0">
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
