    ...
    <nav className={`fixed w-full top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
      <div className="container flex justify-between items-center">
        <div className="flex items-center gap-2 text-primary-navy">
          ...
          <span className={`font-bold text-2xl ${isScrolled ? 'text-primary-navy' : 'text-primary-navy'}`}>Cecsa</span>
        </div>

        {/* Desktop Menu */}
        <div className="hidden md:flex items-center gap-8 font-medium">
          <a href="#inicio" className="hover:text-olive-green text-primary-navy">Inicio</a>
          <a href="#servicios" className="hover:text-olive-green text-primary-navy">Servicios</a>
          <a href="#nosotros" className="hover:text-olive-green text-primary-navy">Nosotros</a>
        ...
        {/* Mobile Toggle */}
        <button className="md:hidden text-primary-navy" onClick={() => setIsMenuOpen(!isMenuOpen)}>
