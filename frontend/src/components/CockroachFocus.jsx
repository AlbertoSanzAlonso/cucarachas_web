      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8 animate-fade-in order-2 md:order-1">
          ...
          <ul className="space-y-4">
            {t('focus.benefits', { returnObjects: true })?.map((item, i) => (
        ...
        <div className="relative order-1 md:order-2 group flex justify-center">
           ...
           <div className="absolute top-0 right-0 px-8 py-4 bg-white shadow-2xl rounded-2xl border border-accent-green/20 animate-bounce z-20">
              <p className="text-[10px] uppercase font-black text-secondary-gray/40 mb-1 tracking-widest leading-none">
                {t('focus.efficacy_label')}
              </p>
              <p className="text-primary-blue font-black text-xl tracking-tighter">
                {t('focus.success_rate')}
              </p>
           </div>
        </div>
