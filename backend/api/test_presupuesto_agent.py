...
class PersistAgentPresupuestoTests(TestCase):
    def test_skips_crm_without_real_phone(self):
        """Sin teléfono no se inventa lead ni presupuesto fantasma."""
        agent = AgentState(
        ...
        self.assertEqual(Cliente.objects.count(), before)

    def test_creates_borrador_when_phone_present(self):
        agent = AgentState(
            customer_name="Hotel Test",
            city="Barcelona",
            property_type="negoci",
        ...
        pres = persist_agent_presupuesto(
            agent,
            {"who": "empresa", "business_type": "hotel", "telefono": "612345678"},
            price_min=180,
            price_max=320,
            final_price=250,
            breakdown=["Inspecció", "Tractament gel"],
        ...
        self.assertEqual(pres.cliente.telefono_norm, "612345678")
